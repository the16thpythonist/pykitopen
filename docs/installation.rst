...
The sources for pykitopen can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/the16thpythonist/pykitopen
.. _tarball: https://github.com/the16thpythonist/pykitopen/tarball/master
